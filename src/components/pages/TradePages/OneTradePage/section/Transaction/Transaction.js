...
const Transaction = () => {
    ...
    const getTime = () => {
        ...
        let nextTime = moment(edDate).add(1, "m").toDate();
                            ...
                            <div className="tb_frm" id="dealViewtb">
                                <table>
                                    ...
                                    <tr className="apply">
                                        <td className="adjustprice" colSpan="3">
                                            <ul className="sblist">
                                                ...
                                                <li>
                                                    ...
                                                    STOP실적 <em className="point2">10</em>
                                                    <span className="grid">/</span>
                                                    Limit실현 <em className="point1">10</em>
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
                                            <div className="btn co1" id="btnBuy" style={{cursor: "pointer"}}
                                                 onClick={() => {
                                                     onBuyingClick()
                                                 }}>
                                                매수신청
                                            </div>
                                            <div className="btn etc1" id="btnReset" style={{cursor: "pointer"}}
                                                 onClick={() => {
                                                     onCancelClick()
                                                 }}>초기화
                                            </div>
                                        ...
                                        <td>
                                            <div className="btn co2" id="btnSell" style={{cursor: "pointer"}}
                                                 onClick={() => {
                                                     onSellingClick()
                                                 }}>매도신청
                                            </div>
                                            <div className="btn etc1" id="btnMaximize" style={{cursor: "pointer"}}
                                                 >MAX
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div className="user_info_row">
                                                ...
                                                <ul className="infolist">
                                                    <li>
                                                        <dl className="dlist">
                                                            <dt>회원명</dt>
                                                            <dd id="userName">김철수</dd>
                                                            <input type="hidden" id="userId"/>
                                                            <input type="hidden" id="niceName"/>
                                                        </dl>
                                                    </li>
                                                    <li>
                                                        <dl className="dlist">
