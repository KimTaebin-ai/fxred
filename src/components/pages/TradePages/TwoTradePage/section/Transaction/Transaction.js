...
const Transaction = () => {
    ...
    const getTime = () => {
        ...
        let nextTime = moment(edDate).add(2, "m").toDate();
                    ...
                    <div className="rtime">
                        ...
                        <span className="inputset">
                            <select id="selChangeTradeTime">
                                ...
                                <option value="2" defaultValue>2분투자</option>
                                        ...
                                        <td className="adjustprice" colSpan="3">
                                            <ul className="sblist">
                                                <li>
                                                    ...
                                                    STOP실적 <em className="point1">20</em>
                                                    <span className="grid">/</span>
                                                    Limit실현 <em className="point2">20</em>
                                                </li>
                                                <li>
                                                    <span className="tit">매도 거래시</span>
                                                    STOP실적 <em className="point2">20</em>
                                                    <span className="grid">/</span>
                                                    Limit실현 <em className="point1">20</em>
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
